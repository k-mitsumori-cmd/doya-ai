...
| 毎日 23:00 UTC (JST 8:00) | `/api/cron/drip-report?slot=morning` | `sendDripReport('morning')` | ドリップ(Resend)配信レポート・朝 (本日の配信予定 + 昨日の実績) |
| 毎日 11:00 UTC (JST 20:00) | `/api/cron/drip-report?slot=evening` | `sendDripReport('evening')` | ドリップ(Resend)配信レポート・夜 (本日の配信実績 + 開封/クリック率) |
