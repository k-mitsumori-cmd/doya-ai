...
const demoResponses: Record<string, string> = {
  'default': `こんにちは！Bunridge AIアシスタントです 👋
...
💡 Bunridgeのダッシュボードで「AIでコピー提案」を使えば、最適な12パターンを一気に生成できますよ！`,
  'LP': `バナーからLPへの導線設計：
...
Bunridge AIなら、LPヒーロー画像専用のバナーも作成可能です！`,
...
Bunridgeなら、SNS各プラットフォームに最適なサイズで生成できます！`,
...
Bunridge AIチャットを使えば、ターゲットに合わせた詳細なイメージ説明を一緒に考えられます！`,
}
          ...
          >
            ...
            <div className="bg-gradient-to-r from-[#635bff] to-[#00d4ff] p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-white">Bunridge AI アシスタント</h3>
