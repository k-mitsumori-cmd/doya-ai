...
// ドヤカンニング（リアルタイム回答支援 / Zoom風の青系）
export const cunningTheme: SidebarTheme = {
  bgGradient: 'bg-gradient-to-b from-[#2D8CFF] via-[#1A6CF0] to-[#0B43C9]',
  navText: 'text-blue-50/85',
  navTextIcon: 'text-sky-100/80',
  sectionText: 'text-sky-100/60',
  toggleText: 'text-[#0B5CFF]',
  toggleHover: 'hover:bg-blue-50',
  brandingText: 'text-blue-100/40',
  profileBg: 'bg-blue-900/30',
  avatarBg: 'bg-[#2D8CFF]',
  loginText: 'text-[#0B5CFF]',
  loginHover: 'hover:bg-blue-50',
  aiBubbleBg: 'bg-blue-700/40',
