...
import { LayoutDashboard, Users, CreditCard, Zap, Eye } from 'lucide-react'
  ...
  return (
    <>
      <SidebarShell isCollapsed={isCollapsed} isMobile={isMobile} theme={aioTheme}>
        <SidebarLogoSection icon={Eye} title="ドヤAIO" subtitle={orgName || orgSlug} showLabel={showLabel} />
          ...
          {(isMobile || !isCollapsed) && (
            <div className="mx-3 md:mx-4 my-2 md:my-4 p-3 md:p-4 rounded-xl md:rounded-2xl bg-gradient-to-br from-white/20 to-white/5 border border-white/20 backdrop-blur-md relative overflow-hidden">
              <div className="relative z-10">
                ...
                <p className="text-[10px] text-purple-100 font-bold leading-relaxed opacity-90 mb-2">プロプラン ¥9,980/月でSoV・引用元・改善アクションも閲覧</p>
