...
type InterviewPlanCode = 'GUEST' | 'FREE' | 'PRO' | 'ENTERPRISE' | 'UNKNOWN'

export function InterviewAppLayout({
  children,
  currentPlan,
  isLoggedIn,
  firstLoginAt,
      ...
      <div className="flex flex-col min-h-screen transition-all duration-300 ease-in-out md:pl-[240px]">
        ...
        <header className="sticky top-0 z-40 bg-white/80 backdrop-blur-md border-b border-gray-200">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-black text-gray-900 leading-none">ドヤインタビューAI</p>
              <p className="text-[10px] font-bold text-gray-400 mt-1">インタビュー記事生成</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href="/interview">
              <button className="h-10 px-4 rounded-xl bg-[#F97316] text-white text-xs font-black shadow-lg shadow-orange-500/20 hover:bg-orange-700 transition-colors inline-flex items-center gap-2">
