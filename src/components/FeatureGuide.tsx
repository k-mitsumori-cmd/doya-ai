            ...
            >
              ...
              <div className="relative aspect-[1200/630] bg-gray-100 flex items-center justify-center overflow-hidden">
                {isLoading ? (
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <p className="text-sm text-gray-400 font-medium">ガイド画像をAIが生成中...</p>
                  </div>
                ) : guideImage ? (
              ...
              <div className="p-6 lg:p-8">
                ...
                <div className="mt-8 pt-6 border-t border-gray-100 flex justify-end">
                  <button 
                    onClick={() => setIsOpen(false)}
                    className="px-8 py-3 bg-[#2563EB] text-white font-bold rounded-xl shadow-lg shadow-blue-500/20 hover:shadow-xl hover:shadow-blue-500/30 transition-all hover:translate-y-[-2px]"
                  >
                    わかった！
                  </button>
                </div>
