...
import { Megaphone, History, CreditCard, Zap } from 'lucide-react'
    ...
    <>
      <SidebarShell isCollapsed={isCollapsed} isMobile={isMobile} theme={adimageTheme}>
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar">
          ...
          {/* 作った数と残り。数字は /api/usage/adimage から受け取るだけ */}
          <SidebarUsagePanel service="adimage" show={sessionReady && (isMobile || !isCollapsed)} refreshEvent="adimage:generated" />
