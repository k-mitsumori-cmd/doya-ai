  ...
  plans: [
    {
      ...
      features: [
        ...
        { text: '打刻修正・休暇申請', included: true },
        { text: 'CSV/Excel出力', included: false },
        { text: '部署勤怠管理', included: false },
      ],
      cta: '無料で始める',
    },
    {
    ...
    },
    {
      ...
      features: [
        { text: '従業員100名まで', included: true },
        { text: '全機能利用可能', included: true },
        { text: '残業・遅刻自動計算', included: true },
        { text: 'CSV/Excel出力', included: true },
        { text: 'メンバー招待', included: true },
        { text: '優先サポート', included: true },
      ],
      cta: 'プロプランを始める',
    },
