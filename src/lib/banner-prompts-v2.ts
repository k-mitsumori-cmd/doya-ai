...
export const BANNER_PROMPTS_V2: BannerPromptV2[] = [
  ...
  // 3. ヒップホップイベント風
  {
    ...
    prompt: {
      ...
      typography: 'メタリック3Dロゴ、出演者名リスト、日時情報',
    },
    fullPrompt: 'A hip-hop after party event poster with dark blue background (#0A1628), group of artists in street fashion at center, metallic 3D logo "MUSIC FES AFTER PARTY" at top, neon blue light effects and smoke, artist names listed at bottom, event date and venue info, live streaming text, urban nightclub atmosphere, 1080x1350 pixels',
  ...
  // 6. お笑い番組風
  {
    ...
    prompt: {
      ...
      typography: 'メタリックロゴ、配信日時、動画配信サービス名',
    },
    fullPrompt: 'A comedy TV show banner with royal blue and gold diagonal stripe background, comedians in suits laughing on both sides, metallic logo "THE COMEDIAN 2025" at top, sparkle effects, broadcast date and streaming service text, entertainment show atmosphere, 1080x1080 pixels',
  ...
  // 9. プレミアムビール風
  {
    ...
    prompt: {
      ...
      designElements: '星形幾何学模様、限定バッジ、高級感のある装飾',
      typography: 'プレミアムビールロゴ、商品名、キャッチコピー',
    },
    fullPrompt: 'A premium craft beer banner with white and gold color scheme, geometric star pattern on left side, premium beer brand text in center, beer can and glass product shot on right, limited edition badge, refreshing taste tagline, elegant sophisticated design, 1200x628 pixels',
  ...
  // 10. スポーツドリンク風
  {
    ...
    category: 'ec',
    name: 'スポーツドリンク',
    displayTitle: 'スポーツドリンク',
    prompt: {
      composition: '正方形、上部にロゴ、中央に商品、両サイドにアスリート',
      subject: 'スポーツドリンクボトル、スノーボーダー、スポーツイベント',
      colorPalette: 'ビビッドブルー（#0066FF）、ホワイト、オレンジアクセント',
      designElements: 'ダイナミックなアクションショット、スポーツバッジ、躍動感',
      typography: 'スポーツドリンクロゴ大きく、パートナーシップテキスト、商品名',
    },
    fullPrompt: 'A sports drink banner with vivid blue background (#0066FF), sports drink brand logo at top, large sports drink bottle at center, snowboarders in action on both sides, dynamic athletic energy, hydration tagline text, professional sports aesthetic, 1080x1080 pixels',
    tags: ['スポーツ', 'ドリンク', 'アスリート', 'ダイナミック', 'ブルー'],
  },
  ...
  // 11. ウイスキー商品紹介風
  {
    ...
    prompt: {
      ...
      typography: 'ウイスキーブランドロゴ、商品スペック箇条書き、限定発売バッジ',
    },
    fullPrompt: 'A premium whisky product banner with dark brown to black gradient background, whisky bottle and glass with amber liquid splash on left, bullet point product specs on right (peated malt, high alcohol content, premium blend), whisky brand logo, limited release red badge, sophisticated masculine aesthetic, 1200x628 pixels',
  ...
  // 12. HR・インタビュー記事風
  {
    ...
    fullPrompt: 'A HR interview article banner with teal and dark gray color blocks at angles, business person portrait with glasses on left side looking thoughtful, "THE ACE FACTOR" title on right, tech company logos, inspirational quote about finding light and walking uncertain paths on left, professional corporate aesthetic, 1200x628 pixels',
  ...
  // 14. カフェ季節限定風
  {
    ...
    prompt: {
      ...
      typography: '商品名大きく、カフェブランドロゴ',
    },
    fullPrompt: 'A cafe seasonal drink banner with cream gold gradient background with Japanese pattern motifs, cafe cup product at center, seasonal tea latte product name prominently displayed, limited time badges, sparkle and confetti effects, festive new year atmosphere, green and gold color accents, 1080x1080 pixels',
    tags: ['カフェ', '季節限定', 'ドリンク', '和風', 'ティーラテ'],
  },
  ...
  // 15. 住宅・不動産風
  {
    ...
    prompt: {
      ...
      typography: '住宅ブランドロゴ、暮らしに関するキャッチコピー',
    },
    fullPrompt: 'A home builder brand banner with bright modern kitchen and living room interior photo at top, family silhouette, elegant home brand logo in center, lifestyle tagline about daily living, No.1 award badge, small house illustrations at bottom, natural wood and white color scheme, warm inviting family home aesthetic, 1080x1350 pixels',
  ...
  // 16. ECセール風
  {
    ...
    prompt: {
      ...
      typography: 'ECサイト名大きく、「MAX95%OFF」強調、「詳細はこちら」CTA',
    },
    fullPrompt: 'A fashion EC sale banner with vivid red background, two models (male and female) in colorful winter clothes smiling at center, large sale logo, shopping tagline, "MAX95%OFF" in white box, pop art style decorations (daruma, trees, house icons), new year sale badge, "詳細はこちら" CTA button, energetic sale atmosphere, 1080x1080 pixels',
  ...
  // 18. モバイル家族割風
  {
    ...
    prompt: {
      ...
      designElements: '桜の花びら、料金表、通信キャリアロゴ',
      typography: '「親子割」大きく、月額料金強調、詳細テキスト',
    },
    fullPrompt: 'A mobile family plan banner with dark navy background and cherry blossom petals, mother and student daughter in school uniform at top, family discount title with arrow, family savings tagline, monthly price prominently displayed, detailed pricing table at bottom, mobile carrier logos, CTA button, spring family campaign aesthetic, 1080x1350 pixels',
  ...
  // 19. ソフトウェア開発ツール風
  {
    ...
    prompt: {
      ...
      typography: '「ソフトウェア開発を自動化」キャッチコピー、開発ツールロゴ、「詳細はこちら」CTA',
    },
    fullPrompt: 'A software development tool banner with dark blue gradient background, business person using laptop photo cropped at angle on left, teal circular CTA button on right, software automation tagline in white, dev tool logo at bottom, modern B2B SaaS aesthetic, clean professional design, 1080x1080 pixels',
