...
export const SERVICES: Service[] = [
  ...
  // ----------------------------------------
  {
    ...
    name: 'ドヤリスト',
    shortName: 'リスト',
    description: 'AIで営業リストを自動生成・アプローチ管理。',
    longDescription: '業界・地域・規模を指定するだけでAIが営業ターゲット企業をリストアップ。AI分析で意思決定者と訴求ポイントを抽出し、メール/DM/電話スクリプトまで自動生成します。',
    icon: '📋',
    color: 'purple',
    ...
    features: [
      'AIによる営業リスト自動生成',
      '企業情報のAI分析（意思決定者・課題・訴求ポイント）',
      'アプローチ文の自動生成（メール/DM/電話/手紙）',
      '一括アプローチ生成',
      'CSV/Excelエクスポート',
      'テンプレート管理',
    ],
    ...
    plans: {
      ...
      pro: {
        name: 'プロ',
        limit: '無制限プロジェクト / 月500社 / 月200アプローチ',
        dailyLimit: 500,
        price: 9980,
