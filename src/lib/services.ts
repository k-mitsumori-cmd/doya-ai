...
export const SERVICES: Service[] = [
  ...
  // URL1本で、サイト診断 × SEO × ペルソナ × ビジュアル × アクションプランを同時生成
  // ----------------------------------------
  {
    id: 'allinone',
    name: 'ドヤマーケAI',
    shortName: 'マーケAI',
    description: 'URL1本で、マーケ課題が全部見える。',
    longDescription:
      'サイトのURLを入れるだけで、サイト診断・SEO分析・ペルソナ自動生成・キービジュアル3案・アクションプランまで、マーケティング施策の"次の一手"をAIが同時多角に可視化する、完全オールインワン・マーケAI。',
    icon: '✨',
    color: 'violet',
    gradient: 'from-violet-500 via-fuchsia-500 to-cyan-400',
    bgGradient: 'from-violet-50 via-white to-cyan-50',
    href: '/allinone',
    dashboardHref: '/allinone',
    pricingHref: '/allinone/pricing',
    guideHref: '/allinone',
    features: [
      'URL 1本で 5軸同時分析（15秒）',
      'サイト / SEO / ペルソナ / ビジュアル / アクションを1画面に集約',
      'AIチャットで深掘り・修正・冗長モード対応',
      'バナー・記事・LP・広告・ペルソナを既存ドヤAIツールへ即連携',
      'PDF / PPTX / Excel / Markdown でレポート出力',
      'キービジュアル3案を AI が自動生成（ビュン演出付き）',
    ],
    useCases: [
      'サイトの課題を丸ごと可視化したい',
      '次に何を強化すべきか優先度を知りたい',
      '社内・提案資料に使える診断レポートが欲しい',
      'マーケ施策の全体設計に AI を活用したい',
    ],
    pricing: {
      free: {
        name: '無料プラン',
      ...
      pro: {
        ...
        dailyLimit: -1,
        price: 9980,
        stripePriceId: process.env.NEXT_PUBLIC_STRIPE_ALLINONE_PRO_PRICE_ID,
      },
    },
    status: 'active',
    category: 'web',
  ...
  // ----------------------------------------
  {
    ...
    name: 'ドヤボイスAI',
    shortName: 'ボイス',
    description: '声を、AIでつくる。',
    longDescription: 'テキストを入力するだけで、自然な日本語ナレーション音声を生成。動画広告・YouTube・ポッドキャスト・社内動画・e-Learningなど、あらゆる音声ニーズに対応。ブラウザ上での録音機能も搭載し、AI音声と人間の声を組み合わせた制作も可能。',
    icon: '🎙️',
    color: 'violet',
    ...
    features: [
      '12種類のボイスキャラクター',
      '話速・ピッチ・音量の詳細調整',
      '感情トーン5種類（ニュートラル/明るい/落ち着き/真剣/やさしい）',
      'SSML対応（高度なテキスト制御）',
      'クラウド録音スタジオ（WebRTC）',
      'AI音声 + 録音の合成',
      'バッチ一括生成',
    ...
    useCases: [
      '動画広告・YouTubeのナレーションを素早く作りたい',
      'e-Learning教材の音声を低コストで制作したい',
      'ポッドキャストの音声品質を高めたい',
      'IVRや社内動画の音声ガイドを量産したい',
    ],
    pricing: {
      free: {
        name: '無料プラン',
