...
const ROWS: ShowcaseRow[] = [
  {
    ...
    visual: <MockWindow title="doya-ai.surisuta.jp/kintai"><KintaiClockMock /></MockWindow>, image: { src: '/kintai/shots/1-input.webp', alt: 'ワンクリックで出退勤を打刻の画面' },
  },
  {
    ...
    visual: <MockWindow title="勤怠集計"><KintaiSummaryMock /></MockWindow>, image: { src: '/kintai/shots/2-process.webp', alt: '勤怠を自動で集計の画面' },
  },
  {
    ...
    visual: <MockWindow title="申請・承認"><KintaiRequestsMock /></MockWindow>, image: { src: '/kintai/shots/3-output.webp', alt: '申請・承認をオンラインで完結の画面' },
  },
]
