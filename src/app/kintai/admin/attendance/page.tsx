...
export default function AdminAttendancePage() {
  ...
  return (
    <div className="p-4 lg:p-6 max-w-6xl mx-auto space-y-4">
      <h1 className="text-lg font-bold text-slate-800">部署勤怠管理</h1>
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-3 flex items-center gap-3">
            <div className="w-9 h-9 rounded-full bg-green-50 flex items-center justify-center">
              <span className="material-symbols-outlined text-green-600 text-lg">work</span>
            </div>
            <div>
              ...
              <p className="text-xs text-green-600">出勤中</p>
            </div>
          </div>
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-3 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-red-500">未出勤</p>
            </div>
          </div>
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-3 flex items-center gap-3">
            <div className="w-9 h-9 rounded-full bg-blue-50 flex items-center justify-center">
              <span className="material-symbols-outlined text-blue-600 text-lg">logout</span>
            </div>
            <div>
              ...
              <p className="text-xs text-blue-600">退勤済</p>
            </div>
          </div>
        </div>
      )}
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody>
              {filtered.length === 0 ? (
                <tr><td colSpan={8} className="px-4 py-8 text-center text-slate-400">データがありません</td></tr>
              ) : (
                <>
