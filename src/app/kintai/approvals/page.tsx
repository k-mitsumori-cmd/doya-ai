  ...
  return (
    <div className="p-4 lg:p-6 max-w-5xl mx-auto space-y-4">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <h1 className="text-lg font-bold text-slate-800">承認管理</h1>
      ...
      {loading ? (
        ...
        <div className="text-center py-12 text-slate-400">
          ...
          {tab === 'pending' ? '未承認の申請はありません' : '該当する申請はありません'}
        </div>
      ) : (
                ...
                {feedback && (
                  <div className={`px-4 py-2 text-sm font-bold flex items-center gap-2 ${
                    ...
                    <span className="material-symbols-outlined text-base">
                      {feedback.type === 'approved' ? 'check_circle' : 'cancel'}
                    </span>
                    {feedback.message}
                  </div>
                )}
                ...
                <div className="p-4">
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1 min-w-0">
                      {/* Employee name + department + time ago */}
                      ...
                      {/* Reviewer comment for rejected/approved */}
                      {r.reviewerComment && (
                        <div className="mt-2 text-sm text-slate-500 flex items-start gap-1.5">
