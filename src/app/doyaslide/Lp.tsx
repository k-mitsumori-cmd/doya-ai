...
const ROWS: ShowcaseRow[] = [
  { icon: 'edit_note', title: '用途とテーマを入力', desc: '資料タイプ、枚数、比率、スタイルを選び、伝えたいことを入力します。', visual: <MockWindow title="資料の条件"><DoyaSlideBriefMock /></MockWindow>, image: { src: '/doyaslide/shots/1-input.webp', alt: '用途とテーマを入力の画面' } },
  { icon: 'account_tree', title: '資料の流れを設計', desc: '目的に合うページ構成を先に作り、全体の話がつながる状態にします。', visual: <MockWindow title="ページ構成"><DoyaSlideStructureMock /></MockWindow>, image: { src: '/doyaslide/shots/2-process.webp', alt: '資料の流れを設計の画面' } },
  { icon: 'view_carousel', title: '全ページを画像で生成', desc: '選んだスタイルと配色を保ちながら、ページごとのビジュアルを作ります。', visual: <MockWindow title="生成結果"><DoyaSlideDeckMock /></MockWindow>, image: { src: '/doyaslide/shots/3-output.webp', alt: '全ページを画像で生成の画面' } },
]
