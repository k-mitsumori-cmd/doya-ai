...
const ROWS: ShowcaseRow[] = [
  {
    ...
    visual: <MockWindow title="doya-ai.surisuta.jp/hr"><HrEmployeesMock /></MockWindow>, image: { src: '/hr/shots/1-input.webp', alt: '顔写真中心の従業員データベースの画面' },
  },
  {
    ...
    visual: <MockWindow title="組織図"><HrOrgChartMock /></MockWindow>, image: { src: '/hr/shots/2-process.webp', alt: '組織図を自動で生成の画面' },
  },
  {
    ...
    visual: <MockWindow title="人事評価"><HrEvalMock /></MockWindow>, image: { src: '/hr/shots/3-output.webp', alt: 'AIが人事評価を支援の画面' },
  },
]
...
export default function HrLandingPage() {
  return (
    <LpShell serviceName="ドヤHR" icon="groups" ctaHref={CTA} ctaLabel="無料ではじめる" accent={ACCENT}>
      ...
      />
      <HowItWorks title={<>登録から評価まで、<br className="md:hidden"  />3ステップ</>} lead="Excelやメールでのバラバラ管理を、ひとつのシステムに集約します。" steps={STEPS} diagram={<ServiceDiagram steps={STEPS} />} />
