...
import { DoyaKun } from '@/components/aio/ui'
    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-purple-50/40">
      <div className="max-w-5xl mx-auto px-6 py-12">
        <div className="text-center mb-10">
          <Link href="/aio" className="inline-flex items-center gap-1 text-sm font-bold text-slate-500 hover:text-slate-700 mb-4">
