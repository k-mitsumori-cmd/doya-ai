...
type SidebarMenuItem = { id: string; label: string; icon: React.ReactNode; href: string; active?: boolean; badge?: string | number; description?: string; preview?: { color: string; stats: string[] } }
...
// ツールチップコンポーネント
function MenuTooltip({ item, show }: { item: SidebarMenuItem; show: boolean }) {
