...
const FAQ_ITEMS = [
  {
    q: 'プロプランで何ができますか？',
    a: 'ペルソナ生成・文章変更を1日30回、追加画像・再生成を1日30枚までご利用いただけます。付属画像はペルソナ1件につき最大16枚まで含まれ、追加枠を消費しません。さらに、ドヤマーケAIの全サービス（SEO・バナー・インタビューなど）のプロ機能も同じ契約で解放されます。',
  },
  {
    q: '無料プランでも使えますか？',
    a: 'はい。ログインすると、ペルソナ生成・文章変更を1日5回、追加画像・再生成を1日5枚までお試しいただけます。付属画像はペルソナ1件につき最大16枚まで含まれます。利用枠は毎日0時（日本時間）にリセットされます。',
  },
  {
