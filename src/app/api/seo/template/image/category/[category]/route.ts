...
const CATEGORY_FALLBACK_IMAGES: Record<string, string> = {
  ビジネス: '/banner-samples/cat-marketing.webp',
  マーケティング: '/banner-samples/cat-marketing.webp',
  テクノロジー: '/banner-samples/cat-it.webp',
  '暮らし・ライフスタイル': '/banner-samples/cat-other.webp',
  '美容・健康': '/banner-samples/cat-beauty.webp',
  '金融・投資': '/banner-samples/cat-finance.webp',
  'EC・通販': '/banner-samples/cat-ec.webp',
  '教育・学習': '/banner-samples/cat-education.webp',
  エンタメ: '/banner-samples/cat-other.webp',
  '旅行・グルメ': '/banner-samples/cat-food.webp',
  認知: '/banner-samples/purpose-lp_hero.webp',
  比較: '/banner-samples/purpose-display.webp',
  CV: '/banner-samples/purpose-campaign.webp',
  解説型: '/banner-samples/purpose-webinar.webp',
  比較型: '/banner-samples/purpose-display.webp',
  一覧型: '/banner-samples/purpose-sns_ad.webp',
  default: '/banner-samples/cat-other.webp',
}
