                                ...
                                <div className="mt-3 space-y-2 max-h-56 overflow-auto pr-1">
                                  {researchEvents.length ? (
                                    researchEvents.map((ev: any) => {
                                      ...
                                      // kindに応じたドットの色
                                      const dotColor = kind === 'success' ? 'bg-emerald-400 shadow-[0_0_0_3px_rgba(16,185,129,0.25)]'
                                        : kind === 'error' ? 'bg-red-400 shadow-[0_0_0_3px_rgba(239,68,68,0.2)]'
                                        : kind === 'warn' ? 'bg-amber-400 shadow-[0_0_0_3px_rgba(245,158,11,0.2)]'
                                        : kind === 'candidates' ? 'bg-blue-400 shadow-[0_0_0_3px_rgba(59,130,246,0.2)]'
                                        : kind === 'fetch' ? 'bg-cyan-400 shadow-[0_0_0_3px_rgba(34,211,238,0.2)]'
                                        : 'bg-white/50 shadow-[0_0_0_3px_rgba(255,255,255,0.1)]'
                                      return (
