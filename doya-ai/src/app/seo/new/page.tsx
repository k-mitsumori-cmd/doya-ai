  ...
  return (
    <DashboardLayout>
      <main className="max-w-4xl mx-auto py-8">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            <button
              ...
              className="inline-flex items-center gap-2 text-gray-500 hover:text-gray-700 text-sm mb-4 transition-colors font-bold"
            >
              <ArrowLeft className="w-4 h-4" />
              一覧へ戻る
            </button>
            <h1 className="text-3xl font-black text-gray-900 tracking-tight">新規記事作成</h1>
            <p className="text-gray-500 mt-1">高品質な記事とビジュアルをワンセットで生成します。</p>
          </div>
          <div className="flex gap-2">
            <Button variant="ghost" size="sm" onClick={fillSample} className="text-gray-400 hover:text-blue-600">
        ...
        {notice && (
          <div className="mb-6 p-4 rounded-2xl bg-blue-50 text-blue-700 text-sm font-bold flex items-center gap-3 border border-blue-100 shadow-sm animate-fade-in">
        ...
        {error && (
          <div className="mb-6 p-4 rounded-2xl bg-red-50 border border-red-100 text-red-700 text-sm animate-fade-in">
        ...
        <div className="space-y-8">
          {/* Simple Inputs Card */}
          <div className="bg-white rounded-[32px] border border-gray-100 p-8 shadow-xl shadow-blue-500/5">
            <div className="grid gap-8">
              <div>
                <div className="flex items-center justify-between mb-3">
                  <label className="text-sm font-black text-gray-700 uppercase tracking-wider">記事タイトル</label>
                  <button
                ...
                <input
                  className="w-full px-6 py-4 rounded-2xl border-2 border-gray-50 bg-gray-50/50 text-gray-900 placeholder:text-gray-300 focus:outline-none focus:border-blue-500 focus:bg-white transition-all text-xl font-bold"
                  value={title}
              ...
              <div>
                <label className="block text-sm font-black text-gray-700 mb-3 uppercase tracking-wider">キーワード</label>
                <input
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-black text-gray-700 mb-3 uppercase tracking-wider">目標文字数</label>
                  <select
                ...
                <div>
                  <label className="block text-sm font-black text-gray-700 mb-3 uppercase tracking-wider">文章トーン</label>
                  <select
                    className="w-full px-6 py-4 rounded-2xl border-2 border-gray-50 bg-gray-50/50 text-gray-900 focus:outline-none focus:border-blue-500 focus:bg-white transition-all font-bold appearance-none"
                    value={tone}
            ...
            <div className="grid grid-cols-3 gap-4">
              {TEMPLATES.map((t) => (
                <button
                  ...
                  className="p-6 rounded-3xl bg-white border border-gray-100 hover:border-blue-500 hover:shadow-lg transition-all text-left group"
                >
          ...
          {/* Bundle Toggle */}
          <div className="bg-gradient-to-br from-[#2563EB] to-blue-700 rounded-[32px] p-8 text-white shadow-2xl shadow-blue-500/20 flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-2xl bg-white/20 backdrop-blur-md flex items-center justify-center">
                <Zap className="w-6 h-6 text-white" />
              </div>
              <div>
                <h3 className="text-lg font-black">セット作成（画像・サムネ込み）</h3>
                <p className="text-blue-100 text-xs font-bold opacity-80">記事内の図解とアイキャッチも全自動で作成します</p>
              </div>
            </div>
          ...
          <div className="space-y-4">
            <button
              ...
              className="w-full py-4 rounded-2xl border border-gray-200 text-gray-400 text-sm font-black flex items-center justify-center gap-2 hover:bg-gray-50 transition-all"
            >
              ...
              <div className="space-y-6 animate-fade-in-up">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-white rounded-3xl border border-gray-100 p-6">
                    <label className="block text-xs font-black text-gray-400 uppercase mb-3">想定ターゲット</label>
                    <textarea
                  ...
                  <div className="bg-white rounded-3xl border border-gray-100 p-6">
                    <label className="block text-xs font-black text-gray-400 uppercase mb-3">検索意図・ニーズ</label>
                    <textarea
                      className="w-full p-4 rounded-xl border border-gray-100 bg-gray-50 text-sm min-h-[100px] focus:outline-none focus:border-blue-500"
                      value={searchIntent}
                ...
                <div className="bg-white rounded-3xl border border-gray-100 p-8">
                  ...
                  <textarea
                    className="w-full p-6 rounded-2xl border border-gray-100 bg-gray-50 text-sm min-h-[100px] focus:outline-none focus:border-blue-500"
                    value={referenceUrls}
          ...
          <div className="pt-8 border-t border-gray-100 flex items-center justify-end gap-4">
            <Button variant="ghost" onClick={saveDraft} className="text-gray-400 font-black">ドラフト保存</Button>
            <Button
              variant="primary"
              onClick={submit}
              disabled={loading || !canSubmit}
              className="px-12 h-16 rounded-2xl bg-[#2563EB] text-white font-black text-xl shadow-2xl shadow-blue-500/30 hover:bg-blue-700 hover:translate-y-[-2px] transition-all disabled:opacity-50"
            >
              {loading ? (
