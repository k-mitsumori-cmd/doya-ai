        ...
        <div className="p-8">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 mb-8">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h2 className="text-lg font-bold text-gray-800">売上と営業コストの推移</h2>
                <p className="text-4xl font-bold text-gray-900 mt-2">64,23%</p>
              </div>
                ...
                <tbody>
                  {CUSTOMER_DATA.map((customer) => (
                    <tr key={customer.id} className="border-b border-gray-50 last:border-0">
                      <td className="py-4 text-sm text-gray-800">{customer.name}</td>
                  ...
                  {week.map((date, dateIndex) => {
                    ...
                    return (
                      <button
                        key={dateIndex}
                        className={`
                          w-full aspect-square rounded-full flex items-center justify-center text-sm transition-colors
          ...
          {/* ゲストバナー */}
          {isGuest && (
            <div className="mt-8 p-4 bg-gradient-to-r from-blue-50 to-cyan-50 border border-blue-200 rounded-2xl">
