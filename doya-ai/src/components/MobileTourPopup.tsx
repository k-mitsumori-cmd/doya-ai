...
export const BANNER_TOUR_SLIDES: MobileTourSlide[] = [
  {
    ...
    title: 'ドヤバナーAIへようこそ！',
    description: 'URLを入力するだけで、AIがサイトを解析し、最適なバナーを自動生成します。',
  ...
  },
  {
    ...
    title: '① サイトURLを入力',
    description: 'バナーを作りたいサイトのURLを入力してください。LPやトップページがおすすめです。',
  ...
  },
  {
    ...
    title: '② 生成ボタンをタップ',
    description: 'AIがサイトを解析し、デザイン・コピー・配色を自動で決定します。約1分お待ちください。',
  ...
  },
  {
    ...
    title: '③ バナーが完成！',
    description: '複数パターンのバナーが生成されます。気に入ったものを選んでダウンロードできます。',
  ...
  },
  {
    ...
    title: '④ ダウンロード',
    description: 'バナーをタップしてダウンロード。SNS広告やWebサイトにすぐ使えます！',
  ...
  },
  {
    ...
    title: '💡 もっと細かく調整したい？',
    description: '「手動で作る」から、用途・業種・サイズなど細かい設定でバナーを生成できます。',
